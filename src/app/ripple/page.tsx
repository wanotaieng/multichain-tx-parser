...
const RIPPLE_EXPLORER_URL = "https://livenet.xrpl.org/transactions";
...
export default function RippleTransactionParser() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (inputType === "json") {
        ...
        response = await fetch("/api/tx-parse/ripple", {
          method: "POST",
          headers: {
        ...
        response = await fetch(`/api/tx-parse/ripple?hash=${transactionHash}`, {
          method: "GET",
        });
  ...
  const getExplorerUrl = (hash: string): string => {
    return `${RIPPLE_EXPLORER_URL}/${hash}`;
  };
  ...
  return (
    <main className="min-h-[85vh] flex flex-col py-8 px-4 bg-gradient-to-b from-blue-50 to-white">
              ...
              <CardContent className="flex-1 min-h-0 p-0">
                {parsedTransaction ? (
                  ...
                  <Textarea
                    ...
                    placeholder="Paste your Ripple transaction JSON here..."
                  ...
                  <div className="p-4">
                    <Input
                      ...
                      className="w-full rounded-lg border-slate-200 focus:border-blue-500"
                    />
                  </div>
                )}
              </CardContent>
